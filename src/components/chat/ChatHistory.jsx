...
function ChatHistory({ onUserClick, lastMessage, chatPartnerUsername, chatID }) {
    ...
    >
      ...
      <VStack spacing={4} align="stretch" alignContent={"left"}>
        <Flex
          ...
          borderRadius="md"
          w="100%"
          onClick={() => onUserClick(chatPartnerUsername)}
        >
<Avatar src={`https://api.adorable.io/avatars/285/${chatID}.png`} name={chatPartnerUsername} mr={3} minW={"55px"} minH={"55px"} />
          <Box flex="1" minW={0}>
